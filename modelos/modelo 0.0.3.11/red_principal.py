...
def entrenar_modelo(Xtrain, ytrain, Xval, yval, path_guardado='modelo_entrenado.h5'):
    ...
    model.add(LSTM(4, return_sequences=True, input_shape=(Xtrain.shape[1], Xtrain.shape[2]), kernel_initializer=initializer ) )
    ...
    #model.add(BatchNormalization())
    model.add(LSTM(8, return_sequences=True, kernel_initializer=initializer ) )
    model.add(BatchNormalization())
    model.add(LSTM(16, return_sequences=True, kernel_initializer=initializer ) )
    model.add(BatchNormalization())
    ...
    model.add(LSTM(8, return_sequences=True, kernel_initializer=initializer ) )
    model.add(BatchNormalization())
    model.add(LSTM(4, return_sequences=True, kernel_initializer=initializer ) )
    model.add(BatchNormalization())
    model.add(LSTM(2, return_sequences=False, kernel_initializer=initializer ) )
    model.add(BatchNormalization())
