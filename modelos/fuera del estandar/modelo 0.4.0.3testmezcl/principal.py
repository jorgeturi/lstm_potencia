...
if __name__ == "__main__":
    ...
    nombre_modelo = "modelo 0.4.0.3testmezcl" 
    ...
    ####### SEPARACION DE DATOS
    inicio_train = 0
    fin_train = 25000 #71500
    inicio_val = fin_train+1
    fin_val = fin_train+1+7000 #18100
    inicio_test = fin_val+1
    fin_test = inicio_test+1+7000 #11615
