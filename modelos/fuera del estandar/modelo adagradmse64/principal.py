...
if __name__ == "__main__":
    ...
    nombre_modelo = "modelo adagradmse64" 
    ...
    X, y = crear_ventana(df[0:200000], 12*4, 1)
   ...
   # Calcular los resultados
    ...
    end = fin_test-1  # Índice final

    # Crear una figura con dos subplots
    fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(12, 8))

    # Graficar yval y prediccionestest en el primer subplot
    ax1.plot(range(start, end), prediccionesTest[start:end], label='pred', color='red')
    ax1.plot(range(start, end), ytest[start:end], label='valores reales', color='green')
