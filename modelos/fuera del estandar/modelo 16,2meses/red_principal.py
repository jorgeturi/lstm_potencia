...
def entrenar_modelo(Xtrain, ytrain, Xval, yval, path_guardado='modelo_entrenado.h5'):
    ...
    values = [0.008, 0.002, 0.001, 0.0001, 0.00005, 0.00001, 0.000004,0.000001,0.0000001]  # Learning rates correspondientes a los intervalos
    ...
    model.add(LSTM(16, return_sequences=False, input_shape=(Xtrain.shape[1], Xtrain.shape[2]), kernel_initializer=initializer ) )
    ...
    optimizer = Adam(learning_rate=lr_schedule, beta_1=0.85, beta_2=0.48, amsgrad=True)
