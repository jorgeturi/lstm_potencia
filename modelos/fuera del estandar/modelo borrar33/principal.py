...
if __name__ == "__main__":
    ...
    df = cargar_datos('potencias.csv','corrientes.csv',dias_semanales=dias, horas=horas)
    ...
    mediciones_previas = 12
    features = mediciones_previas+1
    X, y = crear_ventana(df[0:200000], 1, 1)
    ...
    Xtrain_n = scalerl1.fit_transform(Xtrain)
    Xval_n = scalerl1.transform(Xval)
    Xtest_n = scalerl1.transform(Xtest)
    ...
    # Entrenar el modelo
    modell = entrenar_modelo_dnn(Xtrain_n, ytrain_n, Xval_n, yval_n)
